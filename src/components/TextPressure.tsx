    ...
    const animate = () => {
      ...
      if (titleRef.current) {
        ...
        spansRef.current.forEach((span) => {
          ...
          // Adjust these values to control the minimum and maximum font weight and width.
          // Min weight: 600, Max weight: 900. Min width: 100, Max width: 200.
          const wdth = width ? Math.floor(getAttr(d, maxDist, 100, 200)) : 100;
          const wght = weight ? Math.floor(getAttr(d, maxDist, 600, 900)) : 600;
